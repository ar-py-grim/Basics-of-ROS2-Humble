...
{
public:
    TurtleBot3Controller(const rclcpp::NodeOptions &options) : LifecycleNode("turtlebot_controller", options)
    {
...
RCLCPP_COMPONENTS_REGISTER_NODE(turtlebot3_controller::TurtleBot3Controller)