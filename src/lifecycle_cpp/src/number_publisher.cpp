...
public:
    ...
    LifecycleCallbackReturn on_activate(const rclcpp_lifecycle::State &previous_state)
    {
        ...
        number_timer_->reset(); // reset method of timer
    ...
    LifecycleCallbackReturn on_deactivate(const rclcpp_lifecycle::State &previous_state)
    {
        ...
        number_timer_->cancel(); // cancel the timer like in py file
    ...
    LifecycleCallbackReturn on_cleanup(const rclcpp_lifecycle::State &previous_state)
    {
        ...
        number_publisher_.reset();  // reset the number_publisher pointer, reset method of shared pointer
        number_timer_.reset();      // reset the timer pointer, reset method of shared pointer
        return LifecycleCallbackReturn::SUCCESS;
    }
