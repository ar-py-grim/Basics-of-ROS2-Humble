...
class NumberPublisherNode(LifecycleNode):
    ...
    def on_configure(self, previous_state: LifecycleState):
        ...
        self.number_timer_.cancel()  # this is just to create the timer
        return TransitionCallbackReturn.SUCCESS # or FAILURE, ERROR

    # Activate/Enable HW
    def on_activate(self, previous_state: LifecycleState):
        self.get_logger().info("IN on_activate")
        self.number_timer_.reset()     # timer will start when node transitions to active state
   ...
   # not best method to handle errors, instead use try-catch block
