...
# can also manage a c++ lifecycle node
...
class LifecycleNodeManager(Node):
    ...
    def initialization_sequence(self):
        # Unconfigured state to Inactive state
        ...
        self.get_logger().info("Configuring OK, now inactive state")
        ...
        self.change_state(transition)
        self.get_logger().info("Activating OK, now active state")
